...
-- Trigger drop eval using anon key as system secret
SELECT net.http_post(
  ...
  headers := jsonb_build_object(
    ...
    'x-system-secret', (SELECT decrypted_secret FROM vault.decrypted_secrets WHERE name = 'SUPABASE_ANON_KEY' LIMIT 1)
  ),
  body := '{}'::jsonb
);
