...
-- Update find_hidden_gems to match new gem scoring with word quality focus
-- Also update the on-the-fly fallback scoring to match the edge function
...
BEGIN
  ...
  SELECT
    ...
    g._id, g._domain_name, g._price, g._valuation,
