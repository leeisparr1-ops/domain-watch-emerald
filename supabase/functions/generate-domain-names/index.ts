...
const BATCH_ANGLES = [
  ...
  `Focus on using the user's EXACT KEYWORD as a whole word inside the domain name, combined with a short prefix or suffix to make it registrable. The user's keyword must appear IN FULL — do not abbreviate or truncate it. If the user says "solar", generate names like "SolarForj", "GoSolar", "MySolarHub", "SolarNyx", "TrySolar", "SolarVox", "SolarWave", "SolarPeak". If they say "bio", generate "BioForj", "GoBio", "BioNest", "TryBio", "BioVex". Use prefixes (Go, My, Try, Get, Use, Re, Pro, Top, All) and suffixes (Hub, Lab, Nest, Vox, Fy, Ly, Ify, Wave, Peak, Spot, Zone, Hive, Pad, Kit, Box, Den). Generate 40 unique names, ALL containing the full keyword.`,
